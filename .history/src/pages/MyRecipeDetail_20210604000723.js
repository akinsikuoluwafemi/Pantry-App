     ...
     return (
			<div>
             ...
             <RecipeStatsContainer>
                 ...
                 <StatsHeader><span className="desc">Meal Type</span>: {mealType.map(meal => <Tag>{meal}</Tag> )} </StatsHeader>
                 
                 <StatsHeader><span className="desc">Calories</span>: <Tag >{calories.toFixed(2)}</Tag> </StatsHeader>
                 ...
                 <StatsHeader><span className="desc"></span>Ingredients: {ingredientLines.map(ingredientLine => <ul><li>{ingredientLine}</li></ul> )} </StatsHeader>
