...
const getRecipesCateredToYourPantry = async () => {
	let res1 = await fetchRecipes(
		...
		let res1		fetchAsianRecipes(`https://api.edamam.com/search?q=${itemName}&app_id=${process.env.REACT_APP_APP_ID}&app_key=${process.env.REACT_APP_APP_KEY}&cuisineType=asian`
			);
			fetchMedRecipes(
