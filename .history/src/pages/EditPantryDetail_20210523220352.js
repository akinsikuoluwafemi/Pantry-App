...
function EditPantryItem(props) {
	...
	const [category, setCategory] = useState(pantryDetail.categ);
			...
			<form onSubmit={handleSubmit}>
				...
				<Space>
					<Form.Item label="Quantity">
						<InputNumber min={1} onChange={handleQuantityChange} value={quantity} defaultValue={pantryDetail.quantity} />
					</Form.Item>
...
export default connect(mapStateToProps, { createPantryItem })(EditPantryItem);
