...
import { Tag } from 'antd';
 ...
 function MyRecipeDetail(props) {
     ...
     const {
			cateredRecipesDetail: { label, image, dietLabels, calories, healthLabels, ingredientLines },
		} = props;
     ...
     return (
			<div>
             ...
             <RecipeStatsContainer>
                 ...
                 <StatsHeader>Ingredients: {ingredientLines.map(ingredientLine => <ul><li>{ingredientLines}</li></ul> )} </StatsHeader>
