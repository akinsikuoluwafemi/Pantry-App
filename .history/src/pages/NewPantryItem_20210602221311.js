...
import { fetchAsianRecipes, fetchMedRecipes, fetchRecipes} from '../redux/actions/recipeActions';
...
import { PlusOutlined } from '@ant-design/icons';
 ...
 function NewPantryItem(props) {
	 ...
	 const { createPantryItem,  setItemName } = props;
 ...
 const mapStateToProps = ({pantry: { itemName } }) => {
...
export default connect(mapStateToProps, { createPantryItem, setItemName })(NewPantryItem);