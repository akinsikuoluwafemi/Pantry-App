			...
			<RecipeDetailSectionStyle className="container">
				...
				<RecipeStatsContainer>
					...
					<StatsHeader>
						...
						<NutrientsChipRow>
							<OuterWrapperChip>
								<div className="quantity">{getToFixedValue(cateredRecipesDetail.CHOCDF.quantity)}</div>
								<div>{cateredRecipesDetail.CHOCDF.label}</div>
							</OuterWrapperChip>
							<OuterWrapperChip>
								<div className="quantity">{getToFixedValue(cateredRecipesDetail.PROCNT.quantity)}</div>
								<div>{cateredRecipesDetail.PROCNT.label}</div>
							</OuterWrapperChip>
							<OuterWrapperChip>
								<div className="quantity">{getToFixedValue(cateredRecipesDetail.ENERC_KCAL.quantity)}</div>
								<div>{cateredRecipesDetail.ENERC_KCAL.label}</div>
							</OuterWrapperChip>
							<OuterWrapperChip>
								<div className="quantity">{getToFixedValue(cateredRecipesDetail.SUGAR.quantity)}</div>
								<div>{cateredRecipesDetail.SUGAR.label}</div>
							</OuterWrapperChip>
							<OuterWrapperChip>
								<div className="quantity">{getToFixedValue(cateredRecipesDetail.WATER.quantity)}</div>
								<div>{cateredRecipesDetail.WATER.label}</div>
							</OuterWrapperChip>
						</NutrientsChipRow>
					</StatsHeader>
				</RecipeStatsContainer>
