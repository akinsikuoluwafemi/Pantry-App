...
import { fetchRecipes } from '../redux/actions/recipeActions';
 ...
 function MyRecipe(props) {
	...
	useEffect(() => {
		// getData('prawns')
		fetchRecipes(`https://api.edamam.com/search?q=${itemName}&app_id=${process.env.REACT_APP_APP_ID}&app_key=${process.env.REACT_APP_APP_KEY}&cuisineType=asian&cuisineType=mediterranean`)
	}, [itemName])
