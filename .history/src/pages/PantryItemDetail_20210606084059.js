...
function PantryItemDetail(props) {
	...
	const { pantryDetail, removePantryItem, lastLocation } = props;
			...
			<>
				...
				<PantryDetailValuesWrapper>
					<span className="text-center" style={{ color: '#BCBCBC', display: 'flex', alignItems: 'center' }}>
						<Chip
							size="large"
							style={{ color: '#222', background: '#FDC039', marginRight: '2rem', fontSize: '1.4rem' }}
							label={quantity}
						/>
...
export default connect(mapStateToProps, { removePantryItem })(withLastLocation(PantryItemDetail));