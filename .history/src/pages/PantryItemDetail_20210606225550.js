			...
			>
				...
				<PantryDetailValuesWrapper>
					...
					<PantryDetailTimeWrapper>
						<span>Best Before: <span></span>{moment(expiry).format('DD-MM-YYYY')}</span>

						<span>Time Left: {	getExpiryTimeDifference(moment(expiry), moment(moment(createdAt).format('DD-MM-YYYY')))}</span>
					</PantryDetailTimeWrapper>
				</PantryDetailValuesWrapper>
