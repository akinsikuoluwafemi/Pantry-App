 ...
 function MyRecipeDetail(props) {
	 ...
	 const {
			cateredRecipesDetail: {
				...
				yield: servings,
				totalTime,
				totalNutrients: { ENERC_KCAL, CHOCDF, PROCNT, SUGAR, FAT },
				url,
			},
		} = props;
				...
				<RecipeDetailSectionStyle className="container">
					...
					<RecipeStatsContainer>
						<StatsHeader>
							...
							{totalTime === 0 ? ConvertCookedTime(25) : ConvertCookedTime(totalTime)}
						</StatsHeader>
						...
						<StatsHeader>
							...
							<a href={url} rel="noreferrer" target="_blank" style={{ color: '#F06241' }}>
								Visit Website
							</a>
						</StatsHeader>
					</RecipeStatsContainer>
