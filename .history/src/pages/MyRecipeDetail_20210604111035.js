     ...
     return (
			<div>
             ...
             <RecipeStatsContainer>
                 ...
                 <StatsHeader><span className="desc">HealthLabels</span>: {healthLabels && healthLabels.map(healthLabel => <ul><li>{healthLabel}</li></ul> )} </StatsHeader>
                 <StatsHeader><span className="desc">Ingredients</span>: {ingredient ingredientLines.map(ingredientLine => <ul><li>{ingredientLine}</li></ul> )} </StatsHeader>
