			...
			<RecipeDetailSectionStyle className="container">
				...
				<RecipeStatsContainer>
					...
					<StatsHeader>
						...
						<NutrientsChipRow>
							<OuterWrapperChip>
								<div className="quantity">{getToFixedValue(cateredRecipesDetailCHOCDF.quantity)}</div>
								<div>{cateredRecipesDetailCHOCDF.label}</div>
							</OuterWrapperChip>
							<OuterWrapperChip>
								<div className="quantity">{getToFixedValue(cateredRecipesDetailPROCNT.quantity)}</div>
								<div>{cateredRecipesDetailPROCNT.label}</div>
							</OuterWrapperChip>
							<OuterWrapperChip>
								<div className="quantity">{getToFixedValue(cateredRecipesDetailENERC_KCAL.quantity)}</div>
								<div>{cateredRecipesDetailENERC_KCAL.label}</div>
							</OuterWrapperChip>
							<OuterWrapperChip>
								<div className="quantity">{getToFixedValue(cateredRecipesDetailSUGAR.quantity)}</div>
								<div>{cateredRecipesDetailSUGAR.label}</div>
							</OuterWrapperChip>
							<OuterWrapperChip>
								<div className="quantity">{getToFixedValue(cateredRecipesDetailWATER.quantity)}</div>
								<div>{cateredRecipesDetailWATER.label}</div>
							</OuterWrapperChip>
						</NutrientsChipRow>
					</StatsHeader>
				</RecipeStatsContainer>
