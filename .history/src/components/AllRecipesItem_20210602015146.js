    ...
    return (
		<div style={{ margin: '0 .5rem' }}>
			<Card style={{ borderRadius: '20px', border: 'none' }} loading={loading}>
				...
				<p style={{ textAlign: 'left', paddingTop: '.5rem', margin: '0' }}>{recipe.label.slice(0, 10)}..</p>
				<p style={{ textAlign: 'left', margin: '0' }}>{recipe.totalTime === 0 ? 25 : recipe.totalTime}&nbsp:min</p>
			</Card>
		</div>
	);
}
