    ...
    return (
		<div style={{ margin: '0 .5rem' }}>
			<Card style={{ borderRadius: '20px', border: 'none' }} loading={loading}>
				...
				<RecipeLabel style={{ textAlign: 'left', paddingTop: '.5rem', margin: '0', fontWeight: '600' }}>{recipe.label.slice(0, 10)}..</RecipeLabel>
				<p style={{ textAlign: 'left', margin: '0', color: '#777' }}>{recipe.totalTime === 0 ? 25 : recipe.totalTime}&nbsp;mins</p>
			</Card>
		</div>
	);
}
