...
import { Link , useHistory, useLocat} from 'react-router-dom';
 ...
 function AllRecipesItem(props) {
    ...
    return (
		<Link to={`/${recipe.label}`} onClick={() => getRecipeDetail(recipe)} style={{ margin: '0 .5rem' }} onClick={() => console.log(recipe)}>
